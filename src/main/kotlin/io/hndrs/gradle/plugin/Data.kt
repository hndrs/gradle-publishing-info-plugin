...
data class Developer(val id: String, val name: String, val email: String? = null)
data class Contributor(val name: String, val email: String? = null, val url: String? = null)
